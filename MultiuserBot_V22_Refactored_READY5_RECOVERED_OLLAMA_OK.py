...
class PublicWebSocketManager:
    __slots__ = (
        ...
        "bot",
        "RESUB_COOLDOWN",          # секунды кулдауна между реальными переподписками
        "_next_resub_ts",          # unix-ts, когда можно применить отложенную подписку
        "ws_subscribed",           # текущее множество подписанных символов
        "_pending_symbols",        # отложенное «желаемое» множество символов
