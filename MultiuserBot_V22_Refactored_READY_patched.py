...
# ----------------------------------------------------------------------------------------
    ...
    async def place_unified_order(
        ...
        **kwargs,
        ...
        """Unified V5 place order with idempotent orderLinkId (Bybit HTTP is sync)."""
        ...
        params = {
            ...
            "qty": self._format_qty(symbol, qty),  # используем ваш форматтер
        ...
        # pybit.HTTP is sync — run it in a thread
        ...
        raise RuntimeError(f"Bybit place_order failed: retCode={rc}, retMsg={ret_msg}, resp={str(resp)[:300]}")
